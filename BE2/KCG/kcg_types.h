...
typedef enum kcg_tag_SSM_TR_SM1 {
  SSM_TR_no_trans_SM1,
  SSM_TR_Climb_AutoPilotOff_1_Climb_SM1,
  SSM_TR_Climb_Cruising_2_Climb_SM1,
  SSM_TR_Cruising_AutoPilotOff_1_Cruising_SM1,
  SSM_TR_Cruising_Descent_2_Cruising_SM1,
  SSM_TR_Cruising_Climb_3_Cruising_SM1,
  SSM_TR_Descent_AutoPilotOff_1_Descent_SM1,
  SSM_TR_Descent_Cruising_2_Descent_SM1,
  SSM_TR_AutoPilotOff_Climb_1_AutoPilotOff_SM1,
  SSM_TR_AutoPilotOff_Cruising_2_AutoPilotOff_SM1,
  SSM_TR_AutoPilotOff_Descent_3_AutoPilotOff_SM1
} SSM_TR_SM1;
/* AutoPilot/SM1: */
